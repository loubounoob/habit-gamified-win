...
const PhotoVerification = ({ open, onClose, onVerified }: Props) => {
            ...
            >
              ...
              {result && (
                <motion.div
                  ...
                  className={`bg-glass rounded-xl p-5 mb-6 border ${
                    result.approved ? "border-primary/40" : "border-destructive/40"
                  }`}
                >
                ...
                <div className="flex gap-3">
                  ...
                  {!result && (
                    <button
                      ...
                      className="flex-1 py-3 rounded-xl gradient-primary text-primary-foreground font-bold flex items-center justify-center gap-2 glow-box"
                    >
